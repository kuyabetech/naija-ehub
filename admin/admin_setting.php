    ...
    <main class="main-content">
      ...
      <section class="admin-section" id="settingsSection">
        <div class="section-header" style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 1.2rem; margin-bottom: 1.5rem;">
          <h4 style="font-size: 1.2rem; color: #1a6b54; margin: 0;">System Settings</h4>
          <div class="section-actions" style="display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
            <button class="btn btn-primary" id="editSettingsBtn" style="display: flex; align-items: center; gap: 0.5rem;">
              <i class="fas fa-edit"></i> Edit Settings
            </button>
            <button class="btn btn-outline" id="refreshSettingsBtn" style="display: flex; align-items: center; gap: 0.5rem;">
              <i class="fas fa-sync"></i> Refresh
            </button>
          </div>
        </div>
        <div id="settingsContent" style="background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.07);padding:1.2rem;max-width:500px;margin:auto;">
          <?php if (!empty($settings)): ?>
            <table style="width:100%;border-collapse:collapse;">
              <thead>
                <tr style="background:#f5f5f5;">
                  <th style="padding:0.7rem;text-align:left;">Key</th>
                  <th style="padding:0.7rem;text-align:left;">Value</th>
                </tr>
              </thead>
              <tbody>
                <?php foreach ($settings as $k => $v): ?>
                  <tr>
                    <td style="padding:0.7rem;"><?php echo htmlspecialchars($k); ?></td>
                    <td style="padding:0.7rem;"><?php echo htmlspecialchars($v); ?></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
      ...
      <!-- Edit Settings Modal -->
      <div id="editSettingsModal" class="modal-overlay" style="display: none;">
        <div class="modal user-alert-modal small-modal">
          ...
          <div class="modal-body">
            <form id="editSettingsForm">
              <div id="settingsFields">
                <!-- Settings fields will be loaded here -->
              </div>
