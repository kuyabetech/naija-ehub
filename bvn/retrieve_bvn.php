...
<body>
  <div class="dashboard-container">
    ...
    <?php include __DIR__ . '../includes/header.php'; ?>
      ...
      <div class="bvn-form-section active" id="centralRiskForm">
        ...
        <form class="bvn-form" method="post" action="process_retrieve_bvn_central.php" enctype="multipart/form-data">
          <label>Agent Code
          ...
          <label>Means of Identification
            <input type="file" name="means_of_id" accept=".jpg,.jpeg,.png,.pdf" required>
          </label>
  ...
  <script>
    ...
    // Show popup alert if BVN retrieve was successful
    document.addEventListener('DOMContentLoaded', function() {
      const urlParams = new URLSearchParams(window.location.search);
      if (urlParams.get('success') === '1') {
        showSuccessPopup("Your BVN retrieval request has been submitted. Our team will process it shortly.");
      }
    });
