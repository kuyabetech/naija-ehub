<?php
// NIN Verification v5: NIN + Email
session_start();
require_once('../config/db.php');

define('NIMC_API_URL', 'https://api.nimc.gov.ng/v1/verify-nin-email');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST['nin']) && !empty($_POST['email'])) {
    $nin = trim($_POST['nin']);
